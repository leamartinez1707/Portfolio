    ...
    return (
        <>
            ...
            <div className="habilities-icons my-4 justify-center max-w-4xl mx-auto grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 sm:p-6">
                ...
                <div className="mx-4 my-2 size-18"><img className="icon-habilities py-2 hover:cursor-pointer mx-auto" src="https://skillicons.dev/icons?i=css" alt="Css icon" /><h6><a href="https://developer.mozilla.org/es/docs/Web/CSS" target="blank">CSS</a></h6></div>
                <div className="mx-4 my-2 size-18">
                    <img className="icon-habilities py-2 hover:cursor-pointer mx-auto" src="https://skillicons.dev/icons?i=js" alt="Javascript icon" /><h6><a href="https://developer.mozilla.org/es/docs/Web/JavaScript" target="blank">JS</a></h6></div>
                <div className="mx-4 my-2 size-18">
                ...
                <div className="mx-4 my-2 size-18"><img className="icon-habilities py-2 hover:cursor-pointer mx-auto" src="https://skillicons.dev/icons?i=nodejs" alt="React icon" /><h6><a href="https://nodejs.org/en/learn/getting-started/introduction-to-nodejs" target="blank">NODEJS</a></h6></div>
                <div className="mx-4 my-2 size-18">
                ...
                <div className="mx-4 my-2 size-18"><img className="icon-habilities py-2 hover:cursor-pointer mx-auto" src="https://skillicons.dev/icons?i=mongodb" alt="React icon" /><h6> <a href="https://www.mongodb.com/es" target="blank">MONGODB</a></h6></div>
                <div className="mx-4 my-2 size-18">
                ...
                <div className="mx-4 my-2 size-18">
                    <img className="icon-habilities py-2 hover:cursor-pointer mx-auto" src="https://skillicons.dev/icons?i=vercel" alt="Vercel icon" />
                    <h6>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 max-w-4xl justify-center mx-auto">
                <div className="w-full max-w-1/2 sm:w-full p-6 uppercase mx-auto">
                    <h6 className="text-lg sm:text-2xl m-2 text-white">HTML</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">CSS</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">REACT</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">JS</h6>
                </div>
                <div className="w-full max-w-1/2 sm:w-full  p-6 uppercase mx-auto">
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Diseño web adaptable</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">CSS | Frameworks</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">NPM | Gestión de paquetes</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">GIT | Version control</h6>
                </div>
            </div>
            <div>
            ...
            <div className="grid max-w-4xl justify-center mx-auto">
                <div className="w-full max-w-1/2 sm:w-full p-6 uppercase mx-auto">
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Adaptabilidad</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Comunicación</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Creatividad</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Gestión del tiempo</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Iniciativa</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Pensamiento crítico</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Resolución de problemas</h6>
                    <h6 className="text-lg sm:text-2xl m-2 text-white">Trabajo en equipo</h6>
                </div>
            </div>
