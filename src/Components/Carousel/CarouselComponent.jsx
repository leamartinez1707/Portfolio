            ...
            <article className='mb-4'>
                ...
                <div className="p-2 flex flex-col gap-y-4 text-white justify-between items-start w-full mx-auto">
                    ...
                    <p className="text-left text-lg md:text-xl">
                        {t(`${description}`)} <span onClick={() => handleOpenModal(title, description, descriptionInfo)} className='text-violet-600 hover:text-violet-800 hover:cursor-pointer'>+Info</span>
                    </p>
