        ...
        <>
            <section className='profile-info flex flex-col my-4 mx-auto'>
                <div className='max-w-lg md:max-w-4xl mx-auto'>
                    <h2 className='my-2 text-sm md:text-lg'>Hola! Mi nombre es Leandro Martínez.</h2>
                    <h1 className='h1-title my-2 text-4xl sm:text-6xl'>Desarrollador Web Full Stack.</h1>
                    <h2 className='my-2 text-lg  md:text-xl'>Me encargo de desarrollar páginas web. Conectando Backend y Frontend. </h2>
                    <h2 className='my-2 text-lg  md:text-xl'>Sumamente enfocado en facilitarle la navegación al usuario!</h2>
                </div>
                <div className='max-w-lg md:max-w-4xl mx-auto'>
                    <a
                    ...
                    <img
                        className='w-3/4 max-w-xs sm:w-64 mx-auto justify-center align-center my-4 rounded-full'
