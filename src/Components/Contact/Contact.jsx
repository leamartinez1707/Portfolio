                ...
                <div className="mt-6">
                    ...
                    <ul className="mt-3">
                        <li className="flex items-center">
                            ...
                            <a target="blank" href="mailto:leandro.martinez17@outlook.com" className="text-sm ml-3 text-white hover:underline">
                                <strong>leandro.martinez17@outlook.com</strong>
                            </a>
                        </li>
                    </ul>
                </div>
